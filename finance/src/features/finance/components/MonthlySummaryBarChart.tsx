...
interface IMonthlySummaryBarChartProps {
...
export function MonthlySummaryBarChart({
  transactions,
}: IMonthlySummaryBarChartProps) {
      ...
      <Card className="pt-0">
        <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
          <div className="grid flex-1 gap-1">
            <CardTitle className="text-base md:text-lg">Resumo Mensal</CardTitle>
